            ...
            <form class="row g-3" wire:submit.prevent="save">
                ...
                @if (!$customersDisable)
                    <div class="col-md-{{ $size }}">
                        <label for="customer-list" class="form-label">Select existing customer</label> <span
                            class="text-danger">*</span>
                        <select class="form-select message-customers @error('form.customer_id') is-invalid @enderror"
                            data-placeholder="Select a customer" required wire:model="form.customer_id"
                            wire:change.prevent="handleCustomerChange($event.target.value)">
                ...
                @if (!$companiesDisable)
                    <div class="col-md-{{ $size }}">
                        <label for="company-list" class="form-label">Select existing company</label> <span
                            class="text-danger">*</span>
                        <select class="form-select existing-company @error('form.company_id') is-invalid @enderror"
                            data-placeholder="Select a company" required wire:model="form.company_id"
                            wire:change.prevent="handleCompanyChange($event.target.value)">
                ...
                <div class="col-md-{{ $size }}">
                    <label for="vehicle-number" class="form-label">Select customer vehicle number</label> <span
                        class="text-danger">*</span>
                    <select class="form-select vehicle-numbers @error('form.vehicle_number') is-invalid @enderror"
                        data-placeholder="Select your vehicle number" required wire:model="form.vehicle_number">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control @error('form.origin_country') is-invalid @enderror"
                        id="origin-country" aria-describedby="country of origin" wire:model="form.origin_country">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control @error('form.manufacture_year') is-invalid @enderror"
                        id="manufacture-year" placeholder="Select date year" aria-describedby="year of manufacture"
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control @error('form.middle_tyres') is-invalid @enderror"
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control @error('form.hp') is-invalid @enderror" id="hp"
                        aria-describedby="hp" wire:model="form.hp">
                    @error('form.hp')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
