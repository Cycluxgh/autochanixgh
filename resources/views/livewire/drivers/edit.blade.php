    ...
    <div class="card">
        <div class="card-body">
            <form class="row g-3" wire:submit="update">
                ...
                @endif
                <div class="col-md-6">
                    <label for="customer-list" class="form-label">Customer/Company</label> <span class="text-danger">*</span>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control @error('form.vehicle_number') is-invalid @enderror" id="vehicle-number" wire:model="form.vehicle_number" required>
                ...
                <div class="col-md-6">
                    ...
                    <input type="date" class="form-control @error('manufacture_year') is-invalid @enderror" id="manufacture-year" aria-describedby="year of manufacture" wire:model="form.manufacture_year">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control @error('form.middle.tyres') is-invalid @enderror" id="middle" aria-describedby="middle" wire:model="form.middle_tyres">
