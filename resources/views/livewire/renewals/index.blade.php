        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <button type="button" class="btn btn-primary btn-sm" x-on:click.prevent="$wire.showAddRenewalForm = true">Add Renewal</button>
                </div><!-- end card header -->
                    ...
                    <table id="responsive-datatable" class="table table-bordered table-bordered dt-responsive nowrap">
                        ...
                        @foreach($renewals as $renewal)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ asset($renewal->document) }}" target="_blank" class="text-primary">Document link</a>
                                </td>
...
{{--                                    </a>--}}
                                    <a href="#"
                                       type="button" class="btn btn-sm" data-bs-toggle="tooltip"
                                       data-bs-placement="top" data-bs-title="Edit" x-on:click="$wire.showEditRenewalForm = true" wire:click="edit({{ $renewal->id }})">
                                    ...
                                    <button type="button" class="btn btn-sm" data-bs-toggle="tooltip"
                                        ...
                                        <i class="mdi mdi-trash-can-outline fs-16 align-middle text-danger"
                                           style="cursor: pointer" wire:click.prevent="delete({{ $renewal->id }})"></i>
                                    </button>
                                </span>
                                </td>
                            </tr>
