        ...
        <div id="sidebar-menu">
            ...
            <div class="logo-box">
                ...
                <a href="/" class="logo logo-dark" wire:navigate>
                    ...
                    <span class="logo-lg">
                                    <img src="{{asset('assets/images/logo-dark.png')}}" alt="" height="150" width="200">
                                </span>
                </a>
            </div>
            ...
            <ul id="side-menu">
                ...
                <li>
                    <a href="{{ route('dashboard') }}" class="tp-link"> <i data-feather="home"></i>Dashboard</a>
...
{{--                            <li>--}}
{{--                                <a href="{{ route('dashboard') }}" class="tp-link">Dashboard</a>--}}
{{--                            </li>--}}
{{--                            <li>--}}
{{--                                <a href="{{ route('home') }}" class="tp-link">E-commerce</a>--}}
{{--                            </li>--}}
{{--                        </ul>--}}
{{--                    </div>--}}
                </li>
                ...
                <li>
                    ...
                    <div class="collapse" id="sidebarAuth">
                        <ul class="nav-second-level">
                            <li>
                                <a href="{{ route('customers.create') }}" class="tp-link">Add</a>
                            </li>
                            <li>
                                <a href="{{ route('customers.index') }}" class="tp-link">List</a>
                            </li>
{{--                            <li>--}}
{{--                                <a href="{{ route('customers.drivers.create') }}" class="tp-link">DVLA</a>--}}
{{--                            </li>--}}
{{--                            <li>--}}
...
{{--                            </li>--}}
                ...
                <li>
                    ...
                    <div class="collapse" id="sidebarAdvancedUI">
                        <ul class="nav-second-level">
                            <li>
                                <a href="{{ route('drivers.create') }}" class="tp-link">Add</a>
                            </li>
                            <li>
                                <a href="{{ route('drivers.index') }}" class="tp-link">List</a>
                            </li>
{{--                            <li>--}}
...
{{--                            </li>--}}
                ...
                <li>
{{--                    <a href="{{ route('diagnosis.create') }}" class="tp-link">--}}
...
{{--                    </a>--}}
                    ...
                    <div class="collapse" id="sidebarError">
                        <ul class="nav-second-level">
                            <li>
                                <a href="{{ route('diagnosis.create') }}" class="tp-link">Add</a>
                            </li>
                            <li>
                                <a href="{{ route('diagnosis.index') }}" class="tp-link">List</a>
                            </li>
{{--                            <li>--}}
...
{{--                            </li>--}}
                ...
                <li>
                    <a href="{{ route('messages.create') }}" class="tp-link">
