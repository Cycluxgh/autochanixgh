...
<div>
    <form class="my-4" wire:submit="register">
        ...
        <div class="form-group mb-0 row">
            <div class="col-12">
                <div class="d-grid">
                    <button class="btn btn-primary" type="submit"> Register <span class="spinner-grow spinner-grow-sm"
    ...
    <div class="text-center text-muted mb-4">
        <p class="mb-0">Already have an account ?<a class='text-primary ms-2 fw-medium' href='/login'
                wire:navigate>Login
                here</a></p>
    </div>
</div>
