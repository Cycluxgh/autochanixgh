...
<div>
    <form class="my-4" wire:submit="login">
        ...
        <div class="form-group mb-0 row">
            <div class="col-12">
                <div class="d-grid">
                    <button class="btn btn-primary" type="submit"> Log In <span class="spinner-grow spinner-grow-sm"
    ...
    <div class="text-center text-muted mb-4">
        <p class="mb-0">Don't have an account ?<a class='text-primary ms-2 fw-medium' href='{{ route('register') }}'
                wire:navigate>Register here</a></p>
    </div>
</div>
