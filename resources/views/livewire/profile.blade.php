            ...
            <div class="card-body">
                ...
                <div class="align-items-center">
                    <div class="d-flex align-items-center">
                        <img
                            src="{{asset($image?->temporaryUrl() ?? $user?->image ?? 'assets/images/logo-dark.png')}}"
                            class="rounded-circle avatar-xxl img-thumbnail float-start" alt="image profile">

                        <div class="overflow-hidden ms-4">
                            <h4 class="m-0 text-dark fs-20">{{ ucfirst($user->name) }}</h4>
                            <p class="my-1 text-muted fs-16">{{ $user->email }}</p>
                            @if($user?->phone != null)<span class="fs-15"><i
                                    class="mdi mdi-phone me-2 align-middle"></i>@endif{{ $user?->phone ?? null }} <span> <span
                                        class="badge bg-primary-subtle text-primary px-2 py-1 fs-13 fw-normal">{{ ucfirst($user->role->name) }}</span> @if($user?->address != null)
                                        ,
                                    @endif {{ $user?->address }} </span></span>
                        </div>
                    </div>
                </div>
                ...
                <ul class="nav nav-underline border-bottom pt-2" id="pills-tab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <a class="nav-link active p-2" id="profile_edit_tab" data-bs-toggle="tab"
                           href="#profile_edit"
                           role="tab">
                    ...
                    <li class="nav-item">
                        <a class="nav-link p-2" id="profile_password_tab" data-bs-toggle="tab"
                                ...
                                <div class="row">
                                        ...
                                        <div class="col-lg-12 col-xl-12">
                                            ...
                                            <span class="input-group-text"><i
                                                ...
                                                <input class="form-control" type="text" placeholder="Phone"
                                                       maxlength="10" aria-describedby="phone number"
                                                       wire:model="phone">
                                                <div
                                                    class="text-danger">@error('phone') {{ $message }} @enderror</div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mb-3 col-6">
                                        ...
                                        <div class="col-lg-12 col-xl-12">
                                            <div class="input-group">
                                                ...
                                                <div
                                                    class="text-danger">@error('email') {{ $message }} @enderror</div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="col-lg-12 col-xl-12">
                                            ...
                                            <div
                                                class="text-danger">@error('address') {{ $message }} @enderror</div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mb-3 col-6">
                                        ...
                                        <select class="form-select" id="role" name="role" wire:model="role">
                                            @foreach(\App\RoleEnum::cases() as $role)
                                                <option
                                                    value="{{ $role->value }}">{{ ucfirst($role->value) }}</option>
                                            @endforeach
                                        </select>
                                    </div>
