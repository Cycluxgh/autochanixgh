                    ...
                    <div class="row">
                        @if (!$hideCustomersSelect)
                            <div class="col-12 mb-3">
                                ...
                                <select class="form-select message-customers @error('customer_id') is-invalid @enderror"
                                    data-placeholder="Select a customer" wire:model="customer_id"
                        ...
                        @if (!$hideCompaniesSelect)
                            <div class="col-12 mb-3">
                                ...
                                <select class="form-select existing-company @error('company_id') is-invalid @enderror"
                                    id="companies" data-placeholder="Select a company" wire:model="company_id"
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <select
                                class="form-select existing-vehicle number @error('vehicle_number') is-invalid @enderror"
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <input type="file" id="upload"
                                ...
                                aria-label="upload image/pdf" wire:model="document">
                            @error('document')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
